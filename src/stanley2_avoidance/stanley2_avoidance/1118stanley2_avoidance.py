...
class StanleyAvoidance(Node):
    def __init__(self):
        ...
        self.declare_parameter("waypoints_path", "/home/meric/f1tenth_ws_rl/src/waypoint_generator/src/map_1115.csv")
        self.declare_parameter("waypoints_path_2nd", "/home/meric/f1tenth_ws_rl/src/waypoint_generator/src/map_1115.csv")
...
#        self.utils.draw_marker(pose_msg.header.frame_id, pose_msg.header.stamp, goal_pos_world, self.waypoint_pub, color="red")
    ...
    def drive_to_target_stanley(self):
        ...
        # 여기에 추가  
        self.get_logger().info(f"Waypoint in car frame: x={closest_wheelbase_front_point_car[0]:.2f}, y={closest_wheelbase_front_point_car[1]:.2f}")  
...
class WaypointUtils:
    def __init__(
        ...
        filepath="/home/meric/f1tenth_ws_rl/src/waypoint_generator/src/map_1115.csv",
        min_lookahead=0.5,
        max_lookahead=3.0,
        min_lookahead_speed=3.0,
        max_lookahead_speed=6.0,
        filepath_2nd="/home/meric/f1tenth_ws_rl/src/waypoint_generator/src/map_1115.csv",
        lane_number=0,
    ):
